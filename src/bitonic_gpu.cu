...
/*
* This function exploits a hybrid sort approach. While doing small sorting and merging steps on the CPU
* larger steps will be sent to the GPU and sorted there. 
*/
extern "C" hybrid_sort(uint32_t *arr, int N){
